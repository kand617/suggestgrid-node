...
var RecommendationController = {
     ...
     */
    recommendUsers : function(body, callback){
        ...
        function cb(_error, _response, _context) {
            if(_error) {
                ...
                callback({errorMessage: "No `item_id` or `item_ids` are provided.", errorCode: 422, errorResponse:_response.body},null,_context);
     ...
     */
    recommendItems : function(body, callback){
        ...
        function cb(_error, _response, _context) {
            if(_error) {
                ...
                callback({errorMessage: "No `user_id` or `user_ids` are provided.", errorCode: 422, errorResponse:_response.body},null,_context);
            } else if (_response.statusCode == 429) {
                callback({errorMessage: "Too many requests.", errorCode: 429, errorResponse:_response.body},null,_context);
            } else if (_response.statusCode == 555) {
                callback({errorMessage: "Recommendation model is not found for the given type.", errorCode: 555, errorResponse:_response.body},null,_context);
