...
var SimilarityController = {
     ...
     */
    getSimilarUsers : function(type, body, callback){

        //prepare query string for API call;
        var _baseUri = _configuration.BASEURI;
        
        var _queryBuilder = _baseUri + "/v1/{type}/similar/users";
     ...
     */
    getSimilarItems : function(type, body, callback){

        //prepare query string for API call;
        var _baseUri = _configuration.BASEURI;
        
        var _queryBuilder = _baseUri + "/v1/{type}/similar/items";
