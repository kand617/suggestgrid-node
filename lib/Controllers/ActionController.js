...
var ActionController = {
    ...
    /**
     * Get Actions
     * @param {string|null} type    Optional parameter: The type of the actions. Will return count for all actions if not provided.
     * @param {string|null} userId    Optional parameter: The user id of the actions. Wll return count for all user ids if not provided.
     * @param {string|null} itemId    Optional parameter: The item id of the actions. Wll return count for all item ids if not provided.
     ...
     */
    getActions : function(type, userId, itemId, olderThan, callback){
     ...
     * @return {MessageResponse}
     */
    postAction : function(body, callback){
